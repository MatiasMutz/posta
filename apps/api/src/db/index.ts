...
// Transaction pooler (Supabase :6543 / ?pgbouncer=true): sin prepared statements.
const usaPooler =
  connectionString.includes('pgbouncer=true') || /:6543[/?]/.test(connectionString);

const client = postgres(connectionString, {
  prepare: usaPooler ? false : undefined,
  max: usaPooler ? 1 : undefined,
});
